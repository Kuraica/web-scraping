...
<div class="container">
    ...
    <h3>Processing agents data in ascending order</h3>
...
<script>
    ...
    function startScraping() {
        ...
        chrome.runtime.sendMessage(extensionId, {action: 'checkExtension', order: 'asc'}, function (response) {
    ...
    function continueScraping() {
        ...
        fetch('/api/continue-scraping/asc', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
